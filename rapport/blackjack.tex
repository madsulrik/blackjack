...
\section{Problemformulering} \label{sec:problem}
  ...
  \section{Problemanalyse og design} \label{sec:design}
    ...
    \subsection*{Struktur}
      ...
      \lstinline$index$ er array indeks'et for \texttt{Player}en i \texttt{Player}s arrayen, eller hvornår spilleren har tur,
      ...
      \subsubsection*{Card}
      Et spillekort har en kulør, se Sektionen \ref{sssec:suits}, og en værdi/indeks der repræsentere kortet,
    ...
    \subsection{Klasser} \label{ssec:classes}
      \begin{description}
        \item{\texttt{\texttt{Card}}}~\\
          ...
          dem sammen i streng, som fx ”$\varheartsuit$5”. Hvis et Es (værdi 1) eller billedekort (værdi 
          11-13) vælges, udprintes deres værdi som henholdsvis ”A”, ”J”, ”Q” og ”K”.
        ...
        repræsenterer kortenen som hånden ”holder” og er muterbar, så der kan tilføjes eller fjernes 
        kort fra hånden.\\
        ...
        \begin{description}
          ...
          \item{{\texttt{draw}}}~\\
            ...
            \lstinputlisting[
              caption={Hand.draw: Metode til at tilføje et kort}, label={lst:handDraw}, firstline=42, 
              lastline=42
            ]{../src/blackjack.fsx}
          ...
          \item{{\texttt{toString}}}~\\
            ...
            For alle kort, borset fra første, preprendes et whitespace, for at adskille kortene.
          ...
          samme længde som antallet af kort på hånden. Herefter køres hvert kort på hånden igennem, og for hvert kort findes et tilfældigt nummer fra 0 til det maksimale indeks
